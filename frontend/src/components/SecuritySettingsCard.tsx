    ...
    <Card className="p-6">
      ...
      {stage === 'setup' && (
        <form onSubmit={enable} className="space-y-3">
          ...
          {qr && <img src={qr} alt="2FA QR code" className="h-44 w-44 rounded-md border border-slate-200 dark:border-slate-700" />}
          ...
          <div className="flex gap-2">
            <input
              ...
              className="w-32 rounded-md border border-slate-300 px-3 py-2 text-center font-mono dark:border-slate-600 dark:bg-slate-700"
            />
