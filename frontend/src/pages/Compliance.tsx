...
export default function Compliance() {
  ...
  return (
    <div className="space-y-6">
      ...
      {message && (
        <div className="rounded-lg bg-emerald-50 dark:bg-emerald-900/30 px-4 py-3 text-sm text-emerald-800 dark:text-emerald-200">
          {message}
        </div>
      )}
      {error && (
      ...
      <Card>
        ...
        <select
          ...
          className="form-input w-full max-w-md bg-white text-slate-900 dark:bg-slate-700 dark:text-white"
        >
        ...
        <>
          <Card>
            ...
            {reportableSpells.length > 0 && (
              <div className="mb-4 rounded-lg bg-rose-50 dark:bg-rose-900/30 px-4 py-3 text-sm text-rose-800 dark:text-rose-200">
          ...
          <Card>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              <a
                ...
                className="text-sm underline underline-offset-2 text-slate-600 dark:text-slate-300"
              >
                Download template
              </a>
              <input
            ...
            {payPreview?.rows?.some((r: any) => r.errors.length > 0) && (
              <ul className="mb-4 space-y-1 text-sm text-rose-700 dark:text-rose-300">
                {payPreview.rows
            ...
            {pay && !pay.thresholdKnown && (
              <div className="mb-4 rounded-lg bg-amber-50 dark:bg-amber-900/30 px-4 py-3 text-sm text-amber-800 dark:text-amber-200">
